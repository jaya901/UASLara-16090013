    ...
    <head>
        ...
        <style>
            @foreach($sliders as $key=>$slider)
                ...
                {
                    background: url('{{ asset('public/uploads/slider/'.$slider->image)}}');
                            ...
                            <ul id="menu-pricing" class="menu-price">
                                @foreach($items as $item)
                                    <li class="item" id="{{ $item->category->slug }}">
                                        <a href="#">
                                            <img src="{{ asset('public/uploads/item/'.$item->image)}}" class="img-responsive" alt="Item" style="height: 300px; width: 369px;">
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <div class="copyright text-center">
                            <p>
                                &copy; Copyright, 2019 <a href="#"> Mama's Kitchen. </a> Develop by <a href="#"> Hikmah Wijayanti </a> Theme by <a href="http://themewagon.com/"  target="_blank">ThemeWagon</a>
                            </p>
                        </div>
                    </div>
                </div>
